...
<body style="background: url(img/retro.jpg);">
   ...
   <!-- <fieldset id="fsdyna"> -->
	<legend>   <h3>Information</h3> </legend>
                            <div class="row-fluid">
                                  <form action="searchrecordbackend.php" name="searchrecordlist" id="searchrecordlist">
		 ...
		 <select id="barangaylist" name="barangaylist" onchange="showUser(this.value)">
									 <option value="Agusan">Agusan</option>
                                      ...
                                      <label>Firstname:</label><input type="text" class="input-medium" id="fname" name="fname" autocomplete="off"/>			
                                      <label>Lastname:</label><input type="text" class="input-medium" id="lname" name="lname" autocomplete="off"/>					
...
<script src="js/searchyouthrecord.js"></script> 
