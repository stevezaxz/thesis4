...
if(isset($_SESSION['uid'])) {
    include_once("edituseraccount.php");
}
...
<body style="background: url(img/retro.jpg);">
	...
	<legend>   <h3>Account Information</h3> </legend>
                                        ...
                                        <div class="span6">
                                         ...
                                         <div class="span6">
                                                  ...
                                                  <label class="control-label">Username:</label>
                                                         <div class="controls">
                                                             <input class="input-medium required" type="text" name="username" id="username" value=<?php echo $username;?> readonly>
                    ...
                    <center><input type="submit" value="Done" class="btn btn-primary" id="submit" name="submit"/> </center>
